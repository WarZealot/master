...
/**
 * * This class is an implementation of the {@link ModuleHandlerFactory}, which is registered as a service. It is used
 * to
 * provide EmailActionHandlers.
 *
 * @author Konstantin Tkachuk
 *
 *         27.02.2017
 */
public class GmailModuleHandlerFactory extends BaseModuleHandlerFactory {

    /**
     * The name of the factory.
     */
    public static final String MODULE_HANDLER_FACTORY_NAME = "[GmailModuleHandlerFactory]";
     ...
     * The logger.
     */
    private Logger logger = LoggerFactory.getLogger(GmailModuleHandlerFactory.class);
     ...
     * @param bc
     */
    public GmailModuleHandlerFactory(BundleContext bc) {
        activate(bc);
    ...
    protected ModuleHandler internalCreate(Module module, String ruleUID) {
        ...
        if (EmailActionType.UID.equals(module.getTypeUID())) {
