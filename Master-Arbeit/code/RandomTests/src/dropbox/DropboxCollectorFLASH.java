 ...
 *
 */
public class DropboxCollectorFLASH {
    ...
    static {
        NAMES.add("flash_result_15");
        NAMES.add("flash_result_30");
        NAMES.add("flash_result_45");
        NAMES.add("flash_result_60");
        NAMES.add("flash_result_75");
        NAMES.add("flash_result_150");
    }
